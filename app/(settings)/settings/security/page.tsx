...
export default function SecurityPage() {
  ...
  const handlePasswordSubmit = async (
    ...
    // If you call the Server Action directly, it will automatically reset the form. We don't want that here, because we want to keep the client-side values in the inputs. So instead, we use an event handler which calls the action. You must wrap direct calls with startTranstion. When you use the `action` prop it automatically handles that for you. Another option here is to persist the values to local storage. I might explore alternative options.
    startTransition(() => {
